...
- **PPF-L1/L2 Foundation Protocol v2 — FROZEN / EXECUTION NOT STARTED** — freezes the implementation-independent L1 semantic contract and platform-neutral L2 event-foundation proof requirements. L1 requires `>=30` independently reviewable scenarios; L2 requires `>=40` fixtures and explicit opportunity, missingness, three-time, provenance, multi-device, raw/derived, correction/deletion, and compositional-context semantics. Numeric pattern confidence is not required. L3/L4/L5 and PPF implementation remain blocked. See [ppf-l1-l2-foundation-protocol.md](ppf-l1-l2-foundation-protocol.md).
- **Protocol v2 research traceability — FROZEN / EXECUTION NOT STARTED** — maps each research finding to its Protocol v2 requirement, affected gate, and later proof artifact. See [ppf-l1-l2-protocol-v2-traceability.md](ppf-l1-l2-protocol-v2-traceability.md).
- **Protocol v2 QA — PASS / READY FOR EXECUTION REVIEW** — verifies research coverage, frozen gates, scope integrity, no architecture leakage, and that L1/L2 remain unexecuted. See [ppf-l1-l2-protocol-v2-qa.md](ppf-l1-l2-protocol-v2-qa.md).
