...
- **PPF-L3 Execution Plan — PASS / FROZEN; GENERATOR NOT IMPLEMENTED; BENCHMARK EXECUTION NOT STARTED** — freezes the initial Tier-S execution at **30 synthetic persons, 32 base truth configurations, 188 histories/cases, ~1,004 checkpoints, 14 counterfactual pair templates, person-disjoint 20/20/60 protected splits, STANDARD `2x2` and HIGH-RISK `3x3` replication, three structural holdouts, method/evaluator artifact separation, and evaluator-secret final-test truth**. See [execution plan](ppf-l3-execution-plan.md), [dataset matrix](ppf-l3-dataset-matrix.md), [generator/oracle QA plan](ppf-l3-generator-qa-plan.md), and [artifact layout](ppf-l3-artifact-layout.md). This freezes planning only. Generator implementation requires separate authorization; no history data or recognizer has been created. **PPF-L4 and PPF-L5 remain BLOCKED.**
