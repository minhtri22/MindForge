...
- **PPF-L1/L2 Foundation Protocol — DEFINED / EXECUTION NOT YET RUN** — freezes the proof requirements for defining "Recognize Me" and a platform-neutral personal-event foundation before any pattern algorithm may be implemented. L3/L4/L5 and PPF implementation remain blocked until L1 and L2 pass. See [ppf-l1-l2-foundation-protocol.md](ppf-l1-l2-foundation-protocol.md).
