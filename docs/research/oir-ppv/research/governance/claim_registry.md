...
| H3R Revised Robustness v1.1 | `PROTOCOL FROZEN / QA_PASS_WITH_LIMITS / NOT_EXECUTED / PUBLICATION_PENDING` | `OIR-PPV-H3R v1.1`; observation-channel noise; L1-L4 vs L0/PCA; ENV-1..4; fresh frozen test lock | `NOT_APPLICABLE` | No scientific verdict yet. Freeze QA has P0=0/P1=0; scientific test access count remains 0. Publication/provenance is the next gate. |
...
freeze_status: FROZEN_QA_PASS_WITH_LIMITS_PUBLICATION_PENDING
