"""Formal Q4_K_M replication/qualification entry point for M5Q."""
...
from pipeline.m5q_q4 import run_q4_qualification
...
def main() -> int:
    ...
    if args.as_json:
        ...
        print(f"M5Q Q4_K_M qualification: {result['status']}")
