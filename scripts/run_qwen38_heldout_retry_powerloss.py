...
OUT = ROOT / "runs" / "track-a-qwen38-reference-v1-heldout-retry-powerloss"
CERT = ROOT / "runs" / "track-a-qwen38-reference-v1-harness-certification"

EXPECTED_HEAD = "8ff40dd637aa3eb16d9557621f311aed6351f876"
CERTIFIED_HARNESS_COMMIT = "4437dba66fd3ebbf3749479c180dfe5355d3eafe"
...
def current_freeze(pid: int) -> tuple[psutil.Process, float, dict]:
    ...
    state = {
        ...
        "certified_harness_commit": CERTIFIED_HARNESS_COMMIT,
...
def write_precheck_and_freeze(pid: int) -> None:
    ...
    freeze = {
        ...
        "harness_commit": CERTIFIED_HARNESS_COMMIT,
